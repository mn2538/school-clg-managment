...
import { Box, Typography, Avatar, Menu, MenuItem, IconButton, ListItemIcon, ListItemText } from "@mui/material";
...
const [anchorEl, setAnchorEl] = useState(null);
    ...
    return (
        <Box sx={{display: "flex", height: "100vh"}}>
            <Box sx={{background: "linear-gradient(135deg, #000042 0%, #090979 40%, #0284C7 100%)", width: "15%", color: "#fff"}}>
                Left Box
            </Box>
